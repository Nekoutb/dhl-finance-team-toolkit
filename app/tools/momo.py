...
# --------------------------------------------------------------------------- #
# PDF report parsing (pdfplumber). Best-effort until a real sample arrives:
# 1) largest consistent extracted table wins; 2) text lines above the table on
# page 1 become the report header/metadata.
# --------------------------------------------------------------------------- #
def _read_pdf(path):
    import pdfplumber
